      ...
      populateChart();
         ...
         /* const cursor = e.target.result;
          if (cursor) {
            ...
            indexedDbArray.name="salsa";//cursor.value.status.name;
            indexedDbArray.value="5";//cursor.value.status.value;
            var dateObj = new Date();
 
            indexedDbArray.date=dateObj.getDate()
            //cursor.value.status.date;
